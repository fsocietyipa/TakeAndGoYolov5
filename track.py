        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    tmpObj = {"class": names[int(c)], "count": int("%g"%n), "time": str(datetime.datetime.now())}
                    print(tmpObj)
...
#### python3 track.py --weights /home/fsociety2/Desktop/Yolov5_DeepSort_Pytorch/yolov5/weights/best.pt --source "http://192.168.1.229:8081/"
